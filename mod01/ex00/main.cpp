...
/*   Updated: 2021/10/04 21:32:02 by mrosario         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	get_zombies(std::vector<std::string> *zombie_names, char **argv)
{
	size_t	name_len = 0;
...
int	main(int argc, char **argv)
{
	...
	number_of_zombies = get_zombies(&zombie_names, argv);
	//HEAP ZOMBIES
